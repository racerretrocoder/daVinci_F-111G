...
var Loading_missile = func(name)
{
    ...
    elsif(name == "Aim-54")
    {
	    ...
	    typeid = 52;
        address = "Aircraft/SR71-BlackBird/Models/Missiles/54/AIM54.xml";
        NoSmoke = "Aircraft/SR71-BlackBird/Models/Missiles/54/AIM54.xml";
        Explosion = "Aircraft/F-22/Models/Effects/MissileExplosion/explosion.xml";
        flareres = 0.9990; # Flare and chaff resistance. from 0 to 1 (decimals included) The closer to 1. the harder it is for the missile to fall for enemy chaff and flares. Because flares are checked every 0.1 seconds a high number is needed because this variable is sensitve
        maxdetectionrngnm = 300.8;                    #  
        fovdeg = 360;                                #
        detectionfovdeg = 360;                       # TODO implent data link system so we can control these variables while missile is in flight
        trackmaxdeg = 360;                           # 
        maxg = 8;                                   # wikipedia
        ...
        maxspeed = 5.0;                              # In mach ( source is a guess )
        life = 110; # 
        sdspeed = 0.65;                         # Test Self Destruct Speed. in mach
        fox = "Fox 3";
        rail = "false";

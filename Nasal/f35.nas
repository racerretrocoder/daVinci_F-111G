...
var switch = props.globals.getNode("sim/model/daVinci_F-111G/controls/wings/wings-switch", 1);
...
var cockpit_state = func {
	var switch = getprop("sim/model/daVinci_F-111G/controls/wings/wings-switch");
	if ( switch == 1 ) {
...
var switch = props.globals.getNode("sim/model/daVinci_F-111G/controls/canopy/canopy-switch", 1);
...
# fixes cockpit when use of ac_state.nas #####
var cockpit_state = func {
	var switch = getprop("sim/model/daVinci_F-111G/controls/canopy/canopy-switch");
	if ( switch == 1 ) {

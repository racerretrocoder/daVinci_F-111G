...
daVinci_F-111G.elevon();
daVinci_F-111G.cdu_set(2,1);
print ("daVinci_F-111G systems starting!");
}
...
var elevon = func() {
  ...
  settimer(daVinci_F-111G.elevon,0);
}
...
### failure dialog
#var engine_failures = gui.Dialog.new("dialog","Aircraft/daVinci_F-111G/Dialogs/failures.xml");
#var distance_tanker = gui.Dialog.new("dialog","Aircraft/daVinci_F-111G/Dialogs/distance_to_tanker.xml");
...
var eng_state = func {
    ...
    if(getprop("controls/engines/engine[0]/cutoff") == 0){
        ...
        interpolate("sim/model/daVinci_F-111G/n1[0]",getprop("engines/engine/n1"),3);
        interpolate("sim/model/daVinci_F-111G/n2[0]",getprop("engines/engine/n2"),3);
        #setprop("sim/model/daVinci_F-111G/n1[0]",getprop("engines/engine/n1"));
        #setprop("sim/model/daVinci_F-111G/n2[0]",getprop("engines/engine/n2"));
    }else{
        setprop("controls/engines/engine[0]/throttle-lever", 0);
        interpolate("sim/model/daVinci_F-111G/n1[0]",0,10);
        interpolate("sim/model/daVinci_F-111G/n2[0]",0,10);
    }
    ...
    if(getprop("controls/engines/engine[1]/cutoff") == 0){
        ...
        interpolate("sim/model/daVinci_F-111G/n1[1]",getprop("engines/engine[1]/n1"),3);
        interpolate("sim/model/daVinci_F-111G/n2[1]",getprop("engines/engine[1]/n2"),3);
        #setprop("sim/model/daVinci_F-111G/n1[1]",getprop("engines/engine/n1"));
        #setprop("sim/model/daVinci_F-111G/n2[1]",getprop("engines/engine/n2"));
    }else{
        setprop("controls/engines/engine[1]/throttle-lever", 0);
        interpolate("sim/model/daVinci_F-111G/n1[1]",0,10);
        interpolate("sim/model/daVinci_F-111G/n2[1]",0,10);
    }
    ...
    if(getprop("controls/engines/engine[2]/cutoff") == 0){
        ...
        interpolate("sim/model/daVinci_F-111G/n1[2]",getprop("engines/engine[2]/n1"),3);
        interpolate("sim/model/daVinci_F-111G/n2[2]",getprop("engines/engine[2]/n2"),3);
        #setprop("sim/model/daVinci_F-111G/n1[2]",getprop("engines/engine/n1"));
        #setprop("sim/model/daVinci_F-111G/n2[2]",getprop("engines/engine/n2"));
    }else{
        setprop("controls/engines/engine[2]/throttle-lever", 0);
        interpolate("sim/model/daVinci_F-111G/n1[2]",0,10);
        interpolate("sim/model/daVinci_F-111G/n2[2]",0,10);
    }
    ...
    if(getprop("controls/engines/engine[3]/cutoff") == 0){
        ...
        interpolate("sim/model/daVinci_F-111G/n1[3]",getprop("engines/engine[3]/n1"),3);
        interpolate("sim/model/daVinci_F-111G/n2[3]",getprop("engines/engine[3]/n2"),3);
        #setprop("sim/model/daVinci_F-111G/n1[3]",getprop("engines/engine/n1"));
        #setprop("sim/model/daVinci_F-111G/n2[3]",getprop("engines/engine/n2"));
    }else{
        setprop("controls/engines/engine[3]/throttle-lever", 0);
        interpolate("sim/model/daVinci_F-111G/n1[3]",0,10);
        interpolate("sim/model/daVinci_F-111G/n2[3]",0,10);
    }
